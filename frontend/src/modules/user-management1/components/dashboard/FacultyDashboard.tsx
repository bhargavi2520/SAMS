      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              <label htmlFor="exam-marks" className="text-xs font-medium">
                Exam (out of 30):
              </label>
              <input
                id="exam-marks"
                ...
                placeholder="0"
              />
              <label htmlFor="bit-marks" className="text-xs font-medium">
                Bit Paper (out of 20):
              </label>
              <input
                id="bit-marks"
                ...
                placeholder="0"
              />
              <label htmlFor="assignment-marks" className="text-xs font-medium">
                Assignment (out of 5):
              </label>
              <input
                id="assignment-marks"
                  ...
                  <table className="min-w-full text-xs md:text-sm">
                    ...
                    <tbody>
                      {timeSlots.map((slot, rowIdx) => (
                        <tr key={slot}>
                          <td className="p-2 md:p-3 font-semibold text-center bg-gray-50">
                            {slot}
                          </td>
                            ...
                            if (cell.rest) {
                              return (
                                <td
                                  ...
                                  className="p-2 md:p-3 text-center"
                                >
                                  <span className="inline-block bg-gray-100 text-gray-400 rounded-lg px-2 py-1 text-xs font-medium">
                                    Rest
                                  </span>
                                </td>
                              );
