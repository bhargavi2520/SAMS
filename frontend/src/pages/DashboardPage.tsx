          ...
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-gray-600">
                You have limited access to the system. Please contact an
                administrator to upgrade your account permissions.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="p-6">
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-gray-600">
                Your account role is not recognized. Please contact an
                administrator.
              </p>
            </CardContent>
          </Card>
