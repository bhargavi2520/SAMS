    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-7 gap-2 text-center">
        {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
          <div key={day} className="font-medium text-gray-700 text-sm">
            {day}
          </div>
        ))}
        ...
        {grades.map((item, index) => (
          ...
          >
            ...
            <input
              ...
              value={item.credits}
              onChange={(e) =>
                handleGradeChange(index, "credits", e.target.value)
              }
...
const StudentSidebarNav = ({
  ...
  <>
    {/* Mobile Sidebar */}
    <aside
      className={`fixed inset-y-0 left-0 w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col z-50 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 transition-transform duration-300 ease-in-out`}
    >
...
const StudentDashboard = () => {
  ...
  const [isLoadingFeedbackAnalysis, setIsLoadingFeedbackAnalysis] =
    useState(false);
  ...
  const handleGenerateStudyPlan = async () => {
    if (!examTopicInput.trim()) {
      setStudyPlanResponse(
        "Please enter an exam topic to generate a study plan.",
      );
      return;
    }
      ...
      <main className="flex-1 overflow-auto ml-0 md:ml-64">
        ...
        <div className="p-4 md:p-6">
          ...
          <div
            ref={myProfileRef}
            id="my-profile"
            className="space-y-4 md:space-y-6 scroll-mt-24"
          >
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row items-center sm:space-x-2 mb-2">
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900">
                      {studentProfile?.firstName || "Marcela"}{" "}
                      {studentProfile?.lastName || "Santos"}
                    </h2>
                  ...
                  <p className="text-gray-600 mb-2 md:mb-4 text-sm md:text-base">
                    {studentProfile?.email || "marcela.santos@gmail.com"}
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4 text-xs md:text-sm text-gray-600">
                    <div>
                      <span className="font-medium">National ID:</span>{" "}
                      {studentProfile?.cpf || "043.288.451-09"}
                    </div>
                    <div>
                      <span className="font-medium">Date of birth:</span>{" "}
                      {dayjs(studentProfile?.birthDate).format("DD/MM/YYYY") ||
                        "18/02/1999"}
                    </div>
                    <div>
                      <span className="font-medium">Phone:</span>{" "}
                      {studentProfile?.phone || "(44) 99704-8887"}
                    </div>
                  </div>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-blue-700 mb-3">
                    Enter an exam topic and get a tailored study plan!
                  </p>
                    ...
                    <tbody>
                      ...
                      {[
                        ...
                        <tr
                          ...
                          className="border-b border-gray-100 last:border-b-0"
                        >
                          <td className="py-2 md:py-3 text-gray-600 capitalize">
                            {item.label}
                          </td>
                          <td className="py-2 md:py-3 text-gray-600">
                            {item.attended}
          ...
          >
            <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <CardContent>
                <CalendarComponent />{" "}
                {/* Integrated the new CalendarComponent */}
              </CardContent>
            </Card>
          </div>
          ...
          >
            <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <CardContent>
                <p className="text-gray-600 text-sm">
                  Provide your valuable feedback to help us improve.
                </p>
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <p className="text-sm text-green-700 mb-3">
                    Analyze your feedback for sentiment and categorization.
                  </p>
                  <Button
                    onClick={handleAnalyzeFeedback}
                    disabled={
                      isLoadingFeedbackAnalysis || !feedbackMessageInput.trim()
                    }
