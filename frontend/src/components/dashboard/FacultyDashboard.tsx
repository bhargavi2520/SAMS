...
const FacultyDashboard = () => {
  ...
  const [attendance, setAttendance] = useState<
    { id: number; name: string; present: boolean }[]
  ...
  const handleGenerateStudyMaterial = async () => {
    if (!studyMaterialTopicInput.trim()) {
      setStudyMaterialResponse(
        "Please enter a topic to generate study material.",
      );
      return;
    }
  ...
  const handleDraftAnnouncement = async () => {
    ...
    try {
      ...
      if (result.candidates && result.candidates[0]?.content?.parts[0]?.text) {
        ...
        setAnnouncementResponse(
          "Failed to draft announcement. Please try again.",
        );
      }
    } catch (error) {
      console.error("Error calling Gemini API for announcement:", error);
      setAnnouncementResponse(
        "An error occurred while drafting the announcement.",
      );
    } finally {
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-400 mb-4">
            [Exams content here, e.g., list of upcoming exams]
          </p>
          ...
          <div className="mt-6 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
            ...
            <p className="text-sm text-indigo-700 mb-3">
              Enter an exam topic to generate key study points or practice
              questions.
            </p>
  ...
  const announcementsSection = (
    <div ref={announcementsRef} id="announcements" className="scroll-mt-24">
      <Card>
        ...
        <CardContent>
          <p className="text-gray-400 mb-4">
            [Existing announcements content here, e.g., list of announcements]
          </p>
          ...
          <div className="mt-6 p-4 bg-teal-50 rounded-lg border border-teal-200">
            ...
            <p className="text-sm text-teal-700 mb-3">
              Enter the subject of your announcement to get a draft.
            </p>
            <div className="flex flex-col sm:flex-row gap-2 mb-3">
              <input
                type="text"
        ...
        <div className="p-4 md:p-6">
              ...
              <CardContent>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full text-xs md:text-sm">
                    ...
                    <tbody>{/* ...map your schedule data here... */}</tbody>
                  </table>
                </div>
              </CardContent>
            </Card>
          ...
          <div ref={examsRef} className="pt-4 md:pt-8">
            <Card>
              ...
              <CardContent>{examsSection}</CardContent>
            </Card>
          </div>
          ...
          <div ref={announcementsRef} className="pt-4 md:pt-8">
            <Card>
              ...
              <CardContent>{announcementsSection}</CardContent>
            </Card>
          </div>
        </div>
      </main>
